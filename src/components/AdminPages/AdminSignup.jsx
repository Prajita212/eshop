  ...
  return (
    <div className="w-full h-140 grid items-center justify-center">
      <div className=" bg-white border rounded-3xl p-5 ">
        ...
        <button className="bg-gradient-to-r from-gray-600 to-gray-800 text-white w-40 rounded-2xl mt-7 p-0.5 cursor-pointer">
          Signup
        </button>
        <p className="text-sm mt-1">Already have an account? <Link to="/admin-login" className="hover:underline underline-offset-2 hover:text-green-700">Login</Link></p>
